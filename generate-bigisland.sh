#!/bin/bash
# Generate city+service combo pages for Hawaii Island x top 6 services

ISLAND_SLUG="hawaii-island"
ISLAND_NAME="Hawaii Island"
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                <div class="pricing-table-wrap">
                    ...
                    <div class="pricing-note">Pricing varies based on volume, item type, weight, and access to your ${city_name} property. Remote locations and unpaved roads on ${ISLAND_NAME} may affect cost. All pricing is confirmed onsite before work begins.</div>
                </div>
...
HEREDOC
        count=$((count + 1))
        echo "[$count/60] Created: $dir/index.html"
    done
done
echo ""
echo "Done! Generated $count Hawaii Island city+service pages."
