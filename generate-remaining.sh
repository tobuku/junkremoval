...
<head>
    ...
    <title>${svc_name} in ${city_name}, ${island_name}, HI| RemoveJunkHawaii</title>
    <meta name="description" content="${svc_name} services in ${city_name}, ${island_name}. Professional ${svc_short,,} serving ${city_name} and nearby neighborhoods. Schedule a free onsite estimate.">
    ...
    <meta property="og:description" content="Professional ${svc_short,,} in ${city_name}, ${island_name}. Schedule a free onsite estimate.">
...
<body>
    ...
    <section class="page-hero">
        <div class="container page-hero-content">
            ...
            <p>Professional ${svc_short,,} in ${city_name}. ${city_name} is ${city_desc}. Local providers handle ${svc_items} with same-day and next-day availability. Schedule a free onsite estimate today.</p>
            <div class="page-hero-stats">
                ...
                <div><div class="page-hero-stat-num">Free</div><div class="page-hero-stat-label">Onsite Estimates</div></div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <div class="content-block">
                ...
                <p>Neighborhoods throughout ${city_name} — including $(echo "$neighborhoods" | sed 's/,/, /g') — are all within the service area. Browse our directory to find a provider who serves your specific neighborhood in ${city_name}.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-cta">
                    ...
                    <p>Get a firm price for ${svc_short,,} at your ${city_name} property. Schedule a free onsite estimate today.</p>
                    <ul class="check-list">
                    ...
                    <a href="/companies/" class="btn btn-primary btn-full btn-lg">Find a Provider</a>
                </div>
            </div>
        </div>
    </section>
...
${other_services}            </div>
    ...
    <section class="cta-band">
        <div class="container cta-band-content">
            ...
            <p>Browse our directory to find providers serving ${city_name} and all of ${island_name}.</p>
