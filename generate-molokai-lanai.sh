#!/bin/bash
# Generate city+service combo pages for Molokai + Lanai x top 6 services
...
<head>
    ...
    <meta name="description" content="${svc_name} services in ${city_name}, ${ISLAND_NAME}. Professional ${svc_short,,} serving ${city_name} and nearby areas. Call (808) 536-6075 for service.">
...
<body>
    ...
    <section class="page-hero">
        <div class="container page-hero-content">
            ...
            <p>Professional ${svc_short,,} in ${city_name}. ${city_name} is ${city_desc}. Local providers handle ${svc_items}. Call (808) 536-6075 to schedule service on ${ISLAND_NAME}.</p>
    ...
    <section class="section">
        <div class="container">
            <div class="content-block">
                ...
                <p>${svc_name} in ${city_name} covers the removal of ${svc_items}. ${ISLAND_NAME} is one of Hawaii's most rural islands with limited commercial services, making professional junk removal an important resource for residents and property owners.</p>
                <p>Disposal on ${ISLAND_NAME} requires extra planning. The island has limited landfill capacity and fewer transfer station options than larger islands. Many items must be barged to Oahu for proper disposal or recycling. Local providers understand these logistics and handle routing accordingly.</p>
                <p>Areas throughout ${city_name} — including $(echo "$neighborhoods" | sed 's/,/, /g') — are all within the service area. Call (808) 536-6075 to connect with a provider serving ${ISLAND_NAME}.</p>
            </div>
        </div>
    </section>
    <section class="section alt">
        <div class="container">
            <div class="section-header"><div class="section-label">Service Area</div><h2 class="section-title">${svc_name} Areas on ${ISLAND_NAME}</h2><p class="section-sub">Serving ${city_name} and surrounding ${ISLAND_NAME} communities.</p></div>
            <div class="grid-4">
${neighborhood_pills}            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="section-header centered"><div class="section-label">Pricing</div><h2 class="section-title">${svc_name} Cost on ${ISLAND_NAME}</h2><p class="section-sub">Typical pricing for ${svc_short,,} on ${ISLAND_NAME}. Remote island logistics may affect rates.</p></div>
            <div class="pricing-grid">
                <div class="pricing-table-wrap">
                    <div class="pricing-table-header"><h3>${ISLAND_NAME} ${svc_name} Pricing</h3><p>Typical ranges for ${ISLAND_NAME}</p></div>
                    ...
                    <div class="pricing-note">Pricing on ${ISLAND_NAME} may be higher than on Oahu or Maui due to limited disposal options and barge costs. All pricing is confirmed onsite before work begins.</div>
                </div>
                <div class="pricing-cta">
                    <h3>Call Opala Kuleana</h3>
                    <p>Get a firm price for ${svc_short,,} on ${ISLAND_NAME}. Call (808) 536-6075 today.</p>
                    <ul class="check-list">
                        ...
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>Serving all ${ISLAND_NAME} areas</li>
                    </ul>
    ...
    <section class="section alt">
        <div class="container">
            <div class="section-header"><div class="section-label">More Services</div><h2 class="section-title">Other Services on ${ISLAND_NAME}</h2></div>
...
${other_services}            </div>
    ...
    <section class="cta-band">
        <div class="container cta-band-content">
            <h2>Need ${svc_name} on ${ISLAND_NAME}?</h2>
            <p>Call (808) 536-6075 to connect with providers serving ${ISLAND_NAME}.</p>
...
HEREDOC
        count=$((count + 1))
        echo "[$count] Created: $dir/index.html"
    done
done
...
<head>
    ...
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Service","name":"${svc_name} in ${city_name}, ${ISLAND_NAME}","description":"Professional ${svc_short,,} serving ${city_name} and all of ${ISLAND_NAME}.","provider":{"@type":"Organization","name":"Opala Kuleana","telephone":"(808) 536-6075","url":"https://opalakuleana.com"},"areaServed":{"@type":"City","name":"${city_name}","containedInPlace":{"@type":"AdministrativeArea","name":"${ISLAND_NAME}, Hawaii"}},"serviceType":"${svc_name}"}
    </script>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-J4M41S5XTQ"></script>
<script>
...
<body>
    ...
    <section class="section">
        <div class="container">
            <div class="content-block">
                <h2>${svc_name} Services in ${city_name}</h2>
                <p>${svc_name} in ${city_name} covers the removal of ${svc_items}. ${ISLAND_NAME} is one of Hawaii's smallest inhabited islands with limited commercial services, making professional junk removal an important resource for residents, resort properties, and vacation homeowners.</p>
                <p>Disposal on ${ISLAND_NAME} requires extra planning. The island has very limited landfill capacity and most large items must be barged to Oahu for disposal or recycling. Local providers understand these logistics and coordinate accordingly, often batching jobs to manage barge scheduling efficiently.</p>
                <p>Areas across ${ISLAND_NAME} — including $(echo "$neighborhoods" | sed 's/,/, /g') — are all within the service area. Call (808) 536-6075 to connect with a provider serving ${ISLAND_NAME}.</p>
            </div>
        </div>
    </section>
    <section class="section alt">
        <div class="container">
            <div class="section-header"><div class="section-label">Service Area</div><h2 class="section-title">${svc_name} Areas on ${ISLAND_NAME}</h2><p class="section-sub">Serving ${city_name} and all of ${ISLAND_NAME}.</p></div>
            <div class="grid-4">
${neighborhood_pills}            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                <div class="pricing-table-wrap">
                    ...
                    <div class="pricing-note">Pricing on ${ISLAND_NAME} may be higher than on larger islands due to limited disposal options and barge costs. All pricing is confirmed onsite before work begins.</div>
                </div>
                <div class="pricing-cta">
                    <h3>Call Opala Kuleana</h3>
                    <p>Get a firm price for ${svc_short,,} on ${ISLAND_NAME}. Call (808) 536-6075 today.</p>
                    <ul class="check-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>No-obligation service calls</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>Licensed &amp; insured providers</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>Serving all of ${ISLAND_NAME}</li>
                    </ul>
                    <a href="tel:+18085366075" class="btn btn-primary btn-full btn-lg">Call (808) 536-6075</a>
                </div>
            </div>
...
echo ""
echo "Done! Generated $count Molokai + Lanai city+service pages."
